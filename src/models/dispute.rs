...
impl Dispute {
    pub fn new(amount: String, business_id: String, created_at: String, currency: String, customer: models::CustomerLimitedDetailsResponse, dispute_id: String, dispute_stage: models::DisputeStage, dispute_status: models::DisputeStatus, payment_id: String, payload_type: PayloadType) -> Dispute {
        Dispute {
            amount,
            business_id,
            created_at,
