...
/// CreditLedgerEntryResponse : Response for a ledger entry
...
impl CreditLedgerEntryResponse {
    /// Response for a ledger entry
    pub fn new(amount: String, balance_after: String, balance_before: String, business_id: String, created_at: String, credit_entitlement_id: String, customer_id: String, id: String, is_credit: bool, overage_after: String, overage_before: String, transaction_type: models::CbbLedgerTransactionType) -> CreditLedgerEntryResponse {
