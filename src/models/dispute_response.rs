...
impl DisputeResponse {
    pub fn new(amount: String, business_id: String, created_at: String, currency: String, dispute_id: String, dispute_stage: models::DisputeStage, dispute_status: models::DisputeStatus, payment_id: String) -> DisputeResponse {
        DisputeResponse {
            amount,
            business_id,
            created_at,
